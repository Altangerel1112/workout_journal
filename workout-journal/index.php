...
<head>
    ...
    <title>Workout Tracking Journal</title>
...
<div class="main">
    <div class="headings">
        <h1>Workout Tracking Journal</h1>
    </div>    
    <div class="container row">
        ...
        <div class="title-container col-7">
            <!--<h1>Workout Tracking Journal</h1>-->
            <p>
                Welcome to the Workout Tracking Journal  – your personalized workout journey to a healthier you! This website is designed to support you in achieving your workout goals by providing a user-friendly platform to track your workouts and overall well-being.
            </p>
        </div>
